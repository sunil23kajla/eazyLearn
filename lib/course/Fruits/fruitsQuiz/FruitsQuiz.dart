...
import 'package:eazylearn/course/Fruits/fruitsQuiz/FruitsQuiz_1.dart';
...
class FruitsQuiz extends StatefulWidget {
  const FruitsQuiz({Key? key}) : super(key: key);
  static const String routeName = '/fruits-quiz';
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          Timer(
                              ...
                              () => Navigator.pushNamed(
                                  context, FruiteQuiz_1.routeName));
                        });
                      },
                    ),
                    InkWell(
