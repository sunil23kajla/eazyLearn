import 'package:eazylearn/screen/videos/SelectVideoCoures.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class FruitesDownload extends StatefulWidget {
  const FruitesDownload({Key? key}) : super(key: key);

  static const String routeName = '/fruites-download';

  @override
  State<FruitesDownload> createState() => _FruitesDownloadState();
}

class _FruitesDownloadState extends State<FruitesDownload> {
  @override
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, SelectVideoScreen.routeName);
                        },
                        child: Center(
                            child: Text('Next',
                                style: GoogleFonts.sourceSansPro(
