import 'package:eazylearn/course/Fruits/fruitsQuiz/FruiteQuiz_2.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class FruiteQuiz_1 extends StatefulWidget {
  const FruiteQuiz_1({Key? key}) : super(key: key);

  static const String routeName = '/fruit-quiz_1';

  @override
  State<FruiteQuiz_1> createState() => _FruiteQuiz_1State();
}

class _FruiteQuiz_1State extends State<FruiteQuiz_1> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, FruitesQuiz_2.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
