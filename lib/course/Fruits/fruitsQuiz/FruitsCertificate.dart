import 'package:eazylearn/course/Fruits/fruitsQuiz/FruitesDownloadCertificate.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class FruitsCertificate extends StatefulWidget {
  const FruitsCertificate({Key? key}) : super(key: key);

  static const String routeName = '/fruits-certificate';

  @override
  State<FruitsCertificate> createState() => _FruitsCertificateState();
}

class _FruitsCertificateState extends State<FruitsCertificate> {
  @override
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, FruitesDownload.routeName);
                        },
                        child: Center(
