import 'package:eazylearn/course/Fruits/fruitsQuiz/FruitsCertificate.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class FruitesQuiz_2 extends StatefulWidget {
  const FruitesQuiz_2({Key? key}) : super(key: key);

  static const String routeName = '/fruite-quiz_2';

  @override
  State<FruitesQuiz_2> createState() => _FruitesQuiz_2State();
}

class _FruitesQuiz_2State extends State<FruitesQuiz_2> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, FruitsCertificate.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
