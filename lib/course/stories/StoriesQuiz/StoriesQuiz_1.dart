import 'package:eazylearn/course/stories/StoriesQuiz/StoriesQuiz_2.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class StoriesQuiz_1 extends StatefulWidget {
  const StoriesQuiz_1({Key? key}) : super(key: key);
  static const String routeName = '/stories-quiz-1';

  @override
  State<StoriesQuiz_1> createState() => _StoriesQuiz_1State();
}

class _StoriesQuiz_1State extends State<StoriesQuiz_1> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, StoriesQuiz_2.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
