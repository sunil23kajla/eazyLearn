...
import 'package:eazylearn/course/stories/StoriesQuiz/StoriesQuiz_1.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class StoriesQuiz extends StatefulWidget {
  const StoriesQuiz({Key? key}) : super(key: key);
  static const String routeName = '/stories-quiz';

  @override
  State<StoriesQuiz> createState() => _StoriesQuizState();
}

class _StoriesQuizState extends State<StoriesQuiz> {
  String? leval;
  bool yes = false;
  String text1 = "yes";
  String text2 = "no";
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          Timer(
                              ...
                              () => Navigator.pushNamed(
                                  context, StoriesQuiz_1.routeName));
                        });
                      },
                    ),
                    InkWell(
