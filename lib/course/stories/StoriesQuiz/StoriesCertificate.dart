import 'package:eazylearn/course/stories/StoriesQuiz/StoriesDownloadCertificate.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class StoriesCertificate extends StatefulWidget {
  const StoriesCertificate({Key? key}) : super(key: key);

  static const String routeName = '/stories-certificate';

  @override
  State<StoriesCertificate> createState() => _StoriesCertificateState();
}

class _StoriesCertificateState extends State<StoriesCertificate> {
  @override
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, StoriesDownload.routeName);
                        },
                        child: Center(
