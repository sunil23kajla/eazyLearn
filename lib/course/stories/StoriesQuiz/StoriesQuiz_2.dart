import 'package:eazylearn/course/stories/StoriesQuiz/StoriesCertificate.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class StoriesQuiz_2 extends StatefulWidget {
  const StoriesQuiz_2({Key? key}) : super(key: key);

  static const String routeName = '/stories-Quiz2';

  @override
  State<StoriesQuiz_2> createState() => _StoriesQuiz_2State();
}

class _StoriesQuiz_2State extends State<StoriesQuiz_2> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, StoriesCertificate.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
