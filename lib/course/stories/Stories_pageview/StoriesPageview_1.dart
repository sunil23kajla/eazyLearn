...
import 'package:eazylearn/course/stories/Stories_pageview/StoriesLevel_1.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class StoriesPageview_1 extends StatefulWidget {
  const StoriesPageview_1({Key? key}) : super(key: key);

  static const String routeName = '/stories-pageview1';

  @override
  State<StoriesPageview_1> createState() => _StoriesPageview_1State();
}

class _StoriesPageview_1State extends State<StoriesPageview_1> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      StoriesLevel_1(controller: controller),
    ];
    page = 0;
    super.initState();
  }
