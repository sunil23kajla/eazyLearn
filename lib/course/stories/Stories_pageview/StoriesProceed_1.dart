...
class StoriesProceed_1 extends StatefulWidget {
  const StoriesProceed_1({Key? key}) : super(key: key);
  static const String routeName = '/stories-proceed-1';

  @override
  State<StoriesProceed_1> createState() => _StoriesProceed_1State();
}

class _StoriesProceed_1State extends State<StoriesProceed_1> {
  @override
  void initState() {
    super.initState();
    Timer(const Duration(seconds: 5),
        () => Navigator.pushNamed(context, StoriesPageview_2.routeName));
  }
