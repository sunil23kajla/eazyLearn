...
import 'package:eazylearn/course/stories/StoriesPageview_2/StoriesLevel_2.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class StoriesPageview_2 extends StatefulWidget {
  const StoriesPageview_2({Key? key}) : super(key: key);

  static const String routeName = '/stories-pageview2';

  @override
  State<StoriesPageview_2> createState() => _StoriesPageview_2State();
}

class _StoriesPageview_2State extends State<StoriesPageview_2> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      StoriesLevel_2(controller: controller),
    ];
    page = 0;
    super.initState();
  }
