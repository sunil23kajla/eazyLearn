...
import 'package:eazylearn/course/blank/blankQuiz/blankQuiz_1.dart';
...
class blankQuiz extends StatefulWidget {
  const blankQuiz({Key? key}) : super(key: key);

  static const String routeName = '/blank-quiz';

  @override
  State<blankQuiz> createState() => _blankQuizState();
}
