...
import 'package:eazylearn/course/blank/blankQuiz/blankcetificate.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class blankQuiz_2 extends StatefulWidget {
  const blankQuiz_2({Key? key}) : super(key: key);

  static const String routeName = '/blank-quiz-2';

  @override
  State<blankQuiz_2> createState() => _blankQuiz_2State();
}

class _blankQuiz_2State extends State<blankQuiz_2> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, blankcetificate.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
