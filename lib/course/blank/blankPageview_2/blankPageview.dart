...
import 'package:eazylearn/course/blank/blankPageview_2/blankLevel_2.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class blankPageview_2 extends StatefulWidget {
  const blankPageview_2({
    Key? key,
  }) : super(key: key);

  static const String routeName = '/blank-pageview-2';

  @override
  State<blankPageview_2> createState() => _blankPageview_2State();
}

class _blankPageview_2State extends State<blankPageview_2> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      blankLevel_2(controller: controller),
    ];
    page = 0;
    super.initState();
  }
