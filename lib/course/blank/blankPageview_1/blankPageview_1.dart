...
import 'package:eazylearn/course/blank/blankPageview_1/blankLevel_1.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class blankPageview_1 extends StatefulWidget {
  const blankPageview_1({
    Key? key,
  }) : super(key: key);

  static const String routeName = '/blank-pageview';

  @override
  State<blankPageview_1> createState() => _blankPageview_1State();
}

class _blankPageview_1State extends State<blankPageview_1> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      blankLevel_1(controller: controller),
    ];
    page = 0;
    super.initState();
  }
