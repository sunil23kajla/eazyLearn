...
import 'package:eazylearn/course/blank/blankPageview_2/blankPageview.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class blankProceed_1 extends StatefulWidget {
  const blankProceed_1({Key? key}) : super(key: key);

  static const String routeName = '/blank-proceed-1';

  @override
  State<blankProceed_1> createState() => _blankProceed_1State();
}

class _blankProceed_1State extends State<blankProceed_1> {
  @override
  void initState() {
    super.initState();
