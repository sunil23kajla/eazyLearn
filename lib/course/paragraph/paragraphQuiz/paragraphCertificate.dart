import 'package:eazylearn/course/paragraph/paragraphQuiz/paragraphDownload.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class ParagraphCertificate extends StatefulWidget {
  const ParagraphCertificate({Key? key}) : super(key: key);

  static const String routeName = '/paragraph-certificate';

  @override
  State<ParagraphCertificate> createState() => _ParagraphCertificateState();
}

class _ParagraphCertificateState extends State<ParagraphCertificate> {
  @override
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, ParagraphDownload.routeName);
                        },
                        child: Center(
