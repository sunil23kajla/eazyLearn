import 'package:eazylearn/course/paragraph/paragraphQuiz/paragraphCertificate.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class ParagraphQuiz_2 extends StatefulWidget {
  const ParagraphQuiz_2({Key? key}) : super(key: key);

  static const String routeName = '/paragraph-Quiz2';

  @override
  State<ParagraphQuiz_2> createState() => _ParagraphQuiz_2State();
}

class _ParagraphQuiz_2State extends State<ParagraphQuiz_2> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, ParagraphCertificate.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
