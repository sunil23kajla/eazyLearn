...
import 'package:eazylearn/course/paragraph/paragraphQuiz/paragraphQuiz_1.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class ParagraphQuiz extends StatefulWidget {
  const ParagraphQuiz({Key? key}) : super(key: key);
  static const String routeName = '/paragraph-quiz';

  @override
  State<ParagraphQuiz> createState() => _ParagraphQuizState();
}

class _ParagraphQuizState extends State<ParagraphQuiz> {
  String? leval;
  bool yes = false;
  String text1 = "yes";
  String text2 = "no";
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          Timer(
                              ...
                              () => Navigator.pushNamed(
                                  context, ParagraphQuiz_1.routeName));
                        });
                      },
                    ),
                    InkWell(
