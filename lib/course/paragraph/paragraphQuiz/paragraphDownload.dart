...
import '../../stories/storiesIntro.dart';

class ParagraphDownload extends StatefulWidget {
  const ParagraphDownload({Key? key}) : super(key: key);

  static const String routeName = '/paragraph-download';

  @override
  State<ParagraphDownload> createState() => _ParagraphDownloadState();
}

class _ParagraphDownloadState extends State<ParagraphDownload> {
  @override
              ...
              child: Stack(children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(context, StoriesIntro.routeName);
                        },
                        child: Center(
                            child: Text('Next',
                                style: GoogleFonts.sourceSansPro(
