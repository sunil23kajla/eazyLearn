import 'package:eazylearn/course/paragraph/paragraphQuiz/paragraphQuiz_2.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class ParagraphQuiz_1 extends StatefulWidget {
  const ParagraphQuiz_1({Key? key}) : super(key: key);
  static const String routeName = '/paragraph-quiz-1';

  @override
  State<ParagraphQuiz_1> createState() => _ParagraphQuiz_1State();
}

class _ParagraphQuiz_1State extends State<ParagraphQuiz_1> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, ParagraphQuiz_2.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
