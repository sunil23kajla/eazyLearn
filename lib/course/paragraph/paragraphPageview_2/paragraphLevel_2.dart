import 'package:eazylearn/course/paragraph/paragraphQuiz/paragraphQuiz.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class ParagraphLevel_2 extends StatefulWidget {
  const ParagraphLevel_2({Key? key, required this.controller})
      : super(key: key);

  final PageController controller;
  @override
  State<ParagraphLevel_2> createState() => _ParagraphLevel_2State();
}

class _ParagraphLevel_2State extends State<ParagraphLevel_2> {
  @override
      ...
      body: Column(
        children: [
            ...
            child: Text('My Pet',
                style: GoogleFonts.lora(
                  textStyle: const TextStyle(
                      color: Color(0xFF298B6E),
                      fontSize: 22,
                      fontWeight: FontWeight.w700),
                )),
          ),
          Image.asset(
            'assets/Man_playing.png',
            height: 200,
          ),
          Container(
          ...
          Align(
            ...
            child: InkWell(
              onTap: () {
                Navigator.pushNamed(context, ParagraphQuiz.routeName);
              },
              child: Image.asset(
                'assets/Group66.png',
