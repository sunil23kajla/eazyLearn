...
import 'package:eazylearn/course/words/word_quiz/word_cetificate.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class word_quiz_2 extends StatefulWidget {
  const word_quiz_2({Key? key}) : super(key: key);

  static const String routeName = '/word-quiz-2';

  @override
  State<word_quiz_2> createState() => _word_quiz_2State();
}

class _word_quiz_2State extends State<word_quiz_2> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, word_certificate.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
