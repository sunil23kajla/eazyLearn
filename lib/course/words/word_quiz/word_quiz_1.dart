...
import 'package:eazylearn/course/words/word_quiz/word_quiz_2.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class word_quiz_1 extends StatefulWidget {
  const word_quiz_1({Key? key}) : super(key: key);

  static const String routeName = '/word-quiz-1';

  @override
  State<word_quiz_1> createState() => _word_quiz_1State();
}

class _word_quiz_1State extends State<word_quiz_1> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
