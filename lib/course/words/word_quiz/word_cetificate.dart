import 'package:eazylearn/course/words/word_quiz/wordDownload.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class word_certificate extends StatefulWidget {
  const word_certificate({Key? key}) : super(key: key);

  static const String routeName = '/word-cartificate';

  @override
  State<word_certificate> createState() => _word_certificateState();
}

class _word_certificateState extends State<word_certificate> {
  @override
              ...
              child: Stack(children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(context, WordDownLoad.routeName);
                        },
                        child: Center(
