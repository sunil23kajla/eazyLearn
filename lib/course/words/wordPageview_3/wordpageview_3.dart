...
import 'package:eazylearn/course/words/wordPageview_3/four_word.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class wordPageview_3 extends StatefulWidget {
  const wordPageview_3({
    Key? key,
  }) : super(key: key);

  static const String routeName = '/word-pageview-3';

  @override
  State<wordPageview_3> createState() => _wordPageview_3State();
}

class _wordPageview_3State extends State<wordPageview_3> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      four_word(controller: controller),
    ];
    page = 0;
    super.initState();
  }
