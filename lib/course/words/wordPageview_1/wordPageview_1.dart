...
import 'package:eazylearn/course/words/wordPageview_1/two_words.dart';
...
class wordPageview extends StatefulWidget {
  ...
  static const String routeName = '/word-pageview';

  @override
  State<wordPageview> createState() => _wordPageviewState();
}
...
class _wordPageviewState extends State<wordPageview> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      two_word(controller: controller),
    ];
    page = 0;
    super.initState();
  }
