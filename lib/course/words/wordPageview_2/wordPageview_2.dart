...
import 'package:eazylearn/course/words/wordPageview_2/three_word.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class wordPageview_2 extends StatefulWidget {
  const wordPageview_2({
    Key? key,
  }) : super(key: key);

  static const String routeName = '/word-pageview-2';

  @override
  State<wordPageview_2> createState() => _wordPageview_2State();
}

class _wordPageview_2State extends State<wordPageview_2> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      three_word(controller: controller),
    ];
    page = 0;
    super.initState();
  }
