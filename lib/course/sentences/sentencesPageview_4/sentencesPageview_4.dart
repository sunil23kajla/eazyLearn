...
import 'package:eazylearn/course/sentences/sentencesPageview_4/sentencesLevel_4.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class sentencesPageview_4 extends StatefulWidget {
  const sentencesPageview_4({
    Key? key,
  }) : super(key: key);

  static const String routeName = '/sentences-pageview-4';

  @override
  State<sentencesPageview_4> createState() => _sentencesPageview_4State();
}

class _sentencesPageview_4State extends State<sentencesPageview_4> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      sentencesLevel_4(controller: controller),
    ];
    page = 0;
    super.initState();
  }
