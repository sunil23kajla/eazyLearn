...
import 'package:eazylearn/course/sentences/sentencesQuiz/sentencesQuiz_2.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class sentencesQuiz_1 extends StatefulWidget {
  const sentencesQuiz_1({Key? key}) : super(key: key);

  static const String routeName = '/sentences-quiz-1';

  @override
  State<sentencesQuiz_1> createState() => _sentencesQuiz_1State();
}

class _sentencesQuiz_1State extends State<sentencesQuiz_1> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, sentencesQuiz_2.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
