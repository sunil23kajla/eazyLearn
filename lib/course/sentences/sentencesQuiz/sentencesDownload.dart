import 'package:eazylearn/course/blank/blankIntro.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class SentencesDownload extends StatefulWidget {
  const SentencesDownload({Key? key}) : super(key: key);

  static const String routeName = '/sentences-download';

  @override
  State<SentencesDownload> createState() => _SentencesDownloadState();
}

class _SentencesDownloadState extends State<SentencesDownload> {
  @override
              ...
              child: Stack(children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(context, blankIntro.routeName);
                        },
                        child: Center(
                            child: Text('Next',
                                style: GoogleFonts.sourceSansPro(
