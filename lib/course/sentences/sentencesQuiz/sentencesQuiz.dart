...
import 'package:eazylearn/course/sentences/sentencesQuiz/sentencesQuiz_1.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class sentencesQuiz extends StatefulWidget {
  const sentencesQuiz({Key? key}) : super(key: key);

  static const String routeName = '/sentences-quiz';

  @override
  State<sentencesQuiz> createState() => _sentencesQuizState();
}

class _sentencesQuizState extends State<sentencesQuiz> {
  String? leval;
  bool yes = false;
  String text1 = "yes";
  String text2 = "no";
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          Timer(
                              ...
                              () => Navigator.pushNamed(
                                  context, sentencesQuiz_1.routeName));
                        });
                      },
                    ),
                    InkWell(
