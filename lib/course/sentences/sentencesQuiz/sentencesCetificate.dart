import 'package:eazylearn/course/sentences/sentencesQuiz/sentencesDownload.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class sentencesCertificate extends StatefulWidget {
  const sentencesCertificate({Key? key}) : super(key: key);

  static const String routeName = '/sentences-cartificate';

  @override
  State<sentencesCertificate> createState() => _sentencesCertificateState();
}

class _sentencesCertificateState extends State<sentencesCertificate> {
  @override
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, SentencesDownload.routeName);
                        },
                        child: Center(
