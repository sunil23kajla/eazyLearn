...
import 'package:eazylearn/course/sentences/sentencesQuiz/sentencesCetificate.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class sentencesQuiz_2 extends StatefulWidget {
  const sentencesQuiz_2({Key? key}) : super(key: key);

  static const String routeName = '/sentences-quiz-2';

  @override
  State<sentencesQuiz_2> createState() => _sentencesQuiz_2State();
}

class _sentencesQuiz_2State extends State<sentencesQuiz_2> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('What comes before the letter Q?',
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, sentencesCertificate.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
