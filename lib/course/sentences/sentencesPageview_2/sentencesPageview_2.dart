...
import 'package:eazylearn/course/sentences/sentencesPageview_2/sentencesLevel_2.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class sentencesPageview_2 extends StatefulWidget {
  const sentencesPageview_2({
    Key? key,
  }) : super(key: key);

  static const String routeName = '/sentences-pageview-2';

  @override
  State<sentencesPageview_2> createState() => _sentencesPageview_2State();
}

class _sentencesPageview_2State extends State<sentencesPageview_2> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      sentencesLevel_2(controller: controller),
    ];
    page = 0;
    super.initState();
  }
