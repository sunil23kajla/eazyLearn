...
import 'package:eazylearn/course/sentences/sentencesPageview_3/sentencesPageview_3.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class sentencesProceed_2 extends StatefulWidget {
  const sentencesProceed_2({Key? key}) : super(key: key);

  static const String routeName = '/sentences-proceed-2';

  @override
  State<sentencesProceed_2> createState() => _sentencesProceed_2State();
}

class _sentencesProceed_2State extends State<sentencesProceed_2> {
  @override
  void initState() {
    super.initState();
    Timer(const Duration(seconds: 5),
        () => Navigator.pushNamed(context, sentencesPageview_3.routeName));
  }
      ...
      body: SafeArea(
        ...
        child: Stack(
          children: [
            ...
            //           onTap: () {
            //             Navigator.pushNamed(
            //                 context, sentencesPageview_3.routeName);
            //           },
            //           child: Text('Next',
