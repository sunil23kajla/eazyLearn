...
import 'package:eazylearn/course/sentences/sentencesPageview_1/sentences_Level1.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class sentencesPageview_1 extends StatefulWidget {
  const sentencesPageview_1({
    Key? key,
  }) : super(key: key);

  static const String routeName = '/sentences-pageview';

  @override
  State<sentencesPageview_1> createState() => _sentencesPageview_1State();
}

class _sentencesPageview_1State extends State<sentencesPageview_1> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      sentencesLevel_1(controller: controller),
    ];
    page = 0;
    super.initState();
  }
