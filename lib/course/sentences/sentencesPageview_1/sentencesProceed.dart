...
import 'package:eazylearn/course/sentences/sentencesPageview_2/sentencesPageview_2.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class sentencesProceed_1 extends StatefulWidget {
  const sentencesProceed_1({Key? key}) : super(key: key);

  static const String routeName = '/sentences-proceed-1';

  @override
  State<sentencesProceed_1> createState() => _sentencesProceed_1State();
}

class _sentencesProceed_1State extends State<sentencesProceed_1> {
  @override
  void initState() {
    super.initState();
    Timer(const Duration(seconds: 5),
        () => Navigator.pushNamed(context, sentencesPageview_2.routeName));
  }
      ...
      body: SafeArea(
        ...
        child: Stack(
          children: [
            ...
            //           onTap: () {
            //             Navigator.pushNamed(
            //                 context, sentencesPageview_2.routeName);
            //           },
            //           child: Text('Next',
