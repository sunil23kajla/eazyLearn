...
import 'package:eazylearn/course/match/matchPageview_1/matchLevel_1.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class MatchPageview_1 extends StatefulWidget {
  const MatchPageview_1({Key? key}) : super(key: key);

  static const String routeName = '/match-pageview';

  @override
  State<MatchPageview_1> createState() => _MatchPageview_1State();
}

class _MatchPageview_1State extends State<MatchPageview_1> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      MatchLevel_1(controller: controller),
    ];
    page = 0;
    super.initState();
  }
