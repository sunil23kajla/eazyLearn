import 'package:eazylearn/course/match/matchQuiz/matchCertificate.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class MatchQuiz_2 extends StatefulWidget {
  const MatchQuiz_2({Key? key}) : super(key: key);

  static const String routeName = '/match-quiz-2';

  @override
  State<MatchQuiz_2> createState() => _MatchQuiz_2State();
}

class _MatchQuiz_2State extends State<MatchQuiz_2> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, MatchCetificate.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
