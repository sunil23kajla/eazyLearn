...
import '../../paragraph/intro_paragraph.dart';

class MatchDownload extends StatefulWidget {
  const MatchDownload({Key? key}) : super(key: key);

  static const String routeName = '/match-download';

  @override
  State<MatchDownload> createState() => _MatchDownloadState();
}

class _MatchDownloadState extends State<MatchDownload> {
  @override
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, ParagraphIntro.routeName);
                        },
                        child: Center(
                            child: Text('Next',
                                style: GoogleFonts.sourceSansPro(
