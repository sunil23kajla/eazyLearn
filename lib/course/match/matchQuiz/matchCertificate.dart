import 'package:eazylearn/course/match/matchQuiz/matchDownload.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class MatchCetificate extends StatefulWidget {
  const MatchCetificate({Key? key}) : super(key: key);

  static const String routeName = '/match-cetificate';

  @override
  State<MatchCetificate> createState() => _MatchCetificateState();
}

class _MatchCetificateState extends State<MatchCetificate> {
  @override
              ...
              child: Stack(children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(context, MatchDownload.routeName);
                        },
                        child: Center(
