import 'package:eazylearn/course/match/matchQuiz/matchQuiz_2.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class MatchQuiz_1 extends StatefulWidget {
  const MatchQuiz_1({Key? key}) : super(key: key);

  static const String routeName = '/match-quiz-1';

  @override
  State<MatchQuiz_1> createState() => _MatchQuiz_1State();
}

class _MatchQuiz_1State extends State<MatchQuiz_1> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
