...
import 'package:eazylearn/course/letters/pageview_first/CapitalMatch_1.dart';
import 'package:eazylearn/course/letters/pageview_first/Capital_A.dart';
import 'package:eazylearn/course/letters/pageview_first/Capital_B.dart';
import 'package:eazylearn/course/letters/pageview_first/Capital_C.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class pageviewCapital extends StatefulWidget {
  const pageviewCapital({
    Key? key,
  }) : super(key: key);
  ...
  @override
  State<pageviewCapital> createState() => _pageviewCapitalState();
}

class _pageviewCapitalState extends State<pageviewCapital> {
  ...
  void initState() {
    ...
    _list = <Widget>[
      ...
      CapitalMatch_1(controller: controller),
    ];
    page = 0;
    super.initState();
  }
