...
import 'package:eazylearn/course/letters/quiz/letterCertificate.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class Quiz_2 extends StatefulWidget {
  const Quiz_2({Key? key}) : super(key: key);

  static const String routeName = '/quiz-2';

  @override
  State<Quiz_2> createState() => _Quiz_2State();
}

class _Quiz_2State extends State<Quiz_2> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, letter_certificate.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
