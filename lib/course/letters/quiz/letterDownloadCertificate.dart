import 'package:eazylearn/course/words/wordIntro.dart';
...
class LetterDownload extends StatefulWidget {
  const LetterDownload({Key? key}) : super(key: key);
  static const String routeName = '/letter-download';

  @override
  State<LetterDownload> createState() => _LetterDownloadState();
}
              ...
              child: Stack(children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(context, word_Intro.routeName);
                        },
                        child: Center(
                            child: Text('Next',
                                style: GoogleFonts.sourceSansPro(
