...
import 'package:eazylearn/course/letters/quiz/Quiz_2.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class Quiz_1 extends StatefulWidget {
  const Quiz_1({Key? key}) : super(key: key);

  static const String routeName = '/quiz-1';

  @override
  State<Quiz_1> createState() => _Quiz_1State();
}

class _Quiz_1State extends State<Quiz_1> {
  String? leval;
  late Color color;
  bool first = false;
  bool second = false;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(context, Quiz_2.routeName);
                              },
                              child: Image.asset(
                                'assets/Group66.png',
