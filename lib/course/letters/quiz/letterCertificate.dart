import 'package:eazylearn/course/letters/quiz/letterDownloadCertificate.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../../constant/app_colors.dart';

class letter_certificate extends StatefulWidget {
  const letter_certificate({Key? key}) : super(key: key);

  static const String routeName = '/letter-cartificate';

  @override
  State<letter_certificate> createState() => _letter_certificateState();
}

class _letter_certificateState extends State<letter_certificate> {
  @override
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, LetterDownload.routeName);
                        },
                        child: Center(
